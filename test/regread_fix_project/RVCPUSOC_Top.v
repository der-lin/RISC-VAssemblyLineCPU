...
module RVCPUSOC_Top(
  ...
  // instantiation of cpu
   riscvpipeline U_CPU(
         ...
         .reset(rst),               // reset
         .reg_sel(sw_i[4:0]),       // selected register number when SW[5] = 1
         .reg_data(reg_data),       // selected register data to display path
         .PC(pc),                   // PC
   ...
   // reg_data is driven by the CPU register-file debug read port.
